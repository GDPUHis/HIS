...
package cn.gdpu.his.domain.accessory;
 ...
 *
 */
public class Aphistory extends HISCreateBaseDomain<Long> {
	...
	public boolean equals(Object obj) {
		if(obj instanceof Aphistory == false) return false;
		if(this == obj) return true;
		Aphistory other = (Aphistory)obj;
