...
import cn.gdpu.his.service.IHISBaseService;
 ...
 /**
 * 《inventory loss》 业务逻辑服务接口
 * @author 郭旭辉
 *
 */
public interface IInventorylossService<D extends IHISBaseDAO<T>, T extends BaseDomain> extends IHISBaseService<D, T>,IPageService<D, T>{
